<%@ Page Title="Homeworks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Homeworks_Teacher.aspx.cs" Inherits="DemoWebsite.Homeworks_Teacher" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="ID" runat="server" ToolTip="Enter Homework ID"></asp:TextBox>&nbsp;&nbsp;&nbsp;

    <asp:Label ID="Label2" runat="server" Text="Email"></asp:Label>&nbsp;
    <asp:TextBox ID="Email" runat="server" ToolTip="Enter Student Email"></asp:TextBox>&nbsp;&nbsp;&nbsp;

    <asp:Label ID="Label3" runat="server" Text="Homework Name"></asp:Label>&nbsp;
    <asp:TextBox ID="Name" runat="server" ToolTip="Enter Homework Name"></asp:TextBox>&nbsp;&nbsp;&nbsp;
    ...
    <asp:TextBox ID="Date" runat="server" ToolTip="Enter Homework Date">mm/dd/yyyy</asp:TextBox>&nbsp;&nbsp;&nbsp;
