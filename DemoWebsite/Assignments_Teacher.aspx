<%@ Page Title="Assignments" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Assignments_Teacher.aspx.cs" Inherits="DemoWebsite.Assignments_Teacher" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="ID" runat="server" ToolTip="Enter Assignment ID"></asp:TextBox>&nbsp;&nbsp;&nbsp;
    ...
    <asp:TextBox ID="Name" runat="server" ToolTip="Enter Assignment Name"></asp:TextBox>&nbsp;&nbsp;&nbsp;
    ...
    <asp:TextBox ID="Date" runat="server" ToolTip="Enter Assignment Date">mm/dd/yyyy</asp:TextBox>&nbsp;&nbsp;&nbsp;
    ...
    <asp:TextBox ID="Link" runat="server" ToolTip="Enter Assignment Link">example.com</asp:TextBox>&nbsp;&nbsp;&nbsp;

    <br><br>
    <asp:Button ID="Button1" Text="Add Assignment" runat="server" OnClick="btnSave_Add"/>&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button2" Text="Remove Assignment" runat="server" OnClick="btnSave_Remove"/>&nbsp;&nbsp;&nbsp;
    ...
    <p></p>
     ...
     <columns>
         ...
         <asp:TemplateField HeaderText="Assignment ID" HeaderStyle-Width="10%" ItemStyle-Width="10%">
             <ItemTemplate>  
         ...
         <asp:TemplateField HeaderText="Assignment #" HeaderStyle-Width="10%" ItemStyle-Width="10%">
             <ItemTemplate>  
